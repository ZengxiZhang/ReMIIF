...
class TestDataset_registration(Dataset):
    def __init__(self, data_path, patch_w = None, patch_h = None):
        ...
        self.path = data_path
        self.names = sorted(os.listdir(os.path.join(self.path,'vis_input1')))#[:1]
        self.WIDTH = patch_w
        self.HEIGHT = patch_h
    ...
    def __getitem__(self, index):
        ...
        ir1 = cv2.imread(os.path.join(self.path, 'ir_input1', name))
        ...
        vis2 = cv2.imread(os.path.join(self.path, 'vis_input2', name))
